<%@ Page Language="C#" AutoEventWireup="true" CodeFile="03a_Card2Card__card_3.aspx.cs" Inherits="Pages_MoneyTransfer_03a_Card2Card__card_3" %>
    ...
    <div class="container bank-main">
        <form runat="server" id="mainForm">
            ...
            <ol class="breadcrumb card-flow">
              ...
              <li><a href="03a_Card2Card__card_2.htm">2: Back to Check information</a></li>
              <li><strong>3: Pay</strong></li>
            </ol>

            <div class="money-transfer-smscode">
              <div class="row">You get code on your phone: +38 (063) 555 44 44</div>
              <div class="row">
                <input type="text" class="form-control code-sms" placeholder="Enter code from sms">
              </div>
              <asp:Button runat="server" ID="btnConfirm" Text="Confirm" CssClass="btn btn-success" OnClick="btnConfirm_OnClick" />
              <%--<button type="submit" class="btn btn-success">Confirm</button>--%></p>
            </div>
        </form>
    </div>
