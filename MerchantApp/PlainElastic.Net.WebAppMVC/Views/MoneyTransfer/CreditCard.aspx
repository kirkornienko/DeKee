<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreditCard.aspx.cs" Inherits="Pages_MoneyTransfer_CreditCard" %>
  ...
  <body class="bank-web">
    ...
    <div class="container bank-main">
        <h2 class="secondary-title">
          <div class="icon-wrapper"><i class="fa fa-credit-card"></i></div> Refill card
        </h2>
        ...
        <form class="form-horizontal card-2card-form" runat="server" id="container">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                  ...
                  <asp:DropDownList runat="server" ID="PAN" CssClass="form-control">
                    <asp:ListItem Text="5299640000136129" Value="5299640000136129" />
                    <asp:ListItem Text="5299640000136145" Value="5299640000136145" />
            ...
            <div class="form-group">
              <div class="col-sm-offset-4 col-sm-8">
                <asp:Button runat="server" ID="CreditCard" Text="Credit card" OnClick="CreditCard_OnClick" CssClass="btn btn-success" />
