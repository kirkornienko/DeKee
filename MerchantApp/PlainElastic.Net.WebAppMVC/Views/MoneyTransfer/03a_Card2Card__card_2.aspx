<%@ Page Language="C#" AutoEventWireup="true" CodeFile="03a_Card2Card__card_2.aspx.cs" Inherits="Pages_MoneyTransfer_03a_Card2Card__card_2" %>
  ...
  <body class="bank-web">
    ...
    <div class="container bank-main">
        ...
        <ol class="breadcrumb card-flow">
          <li><a href="03a_Card2Card__card_1.htm">1: Back to Car Info</a></li>
          <li><a href="03a_Card2Card__card_2.htm">2: Check information</a></li>
          <li>3: Pay</li>
        </ol>

        <div class="row card-transfer-line">
          <div class="col-xs-12 col-sm-6 col-md-6 card-transfer-dack card-from">
            <div class="row card-transfer-ditails">
              <div class="col-xs-12 col-sm-12 col-md-4 text-right"><strong>From:</strong></div>
              <div class="col-xs-12 col-sm-12 col-md-8">John Dou</div>
            </div>
            <div class="row card-transfer-ditails">
              <div class="col-xs-12 col-sm-12 col-md-4 text-right"><strong>Card Number:</strong></div>
              <div class="col-xs-12 col-sm-12 col-md-8">
                <asp:Label runat="server" ID="Sender" />
              </div>
            </div>
            <div class="row card-transfer-ditails">
              <div class="col-xs-12 col-sm-12 col-md-4 text-right"><strong>Amount:</strong></div>
              <div class="col-xs-12 col-sm-12 col-md-8">
                    <asp:Label runat="server" ID="AmountFormatted" />
              </div>
            </div>
          </div>
          <div class="hidden-xs card-transfer-arrow-from"><i class="fa fa-arrow-circle-o-right"></i></div>
          <div class="col-xs-12 col-sm-6 col-md-6 card-transfer-dack">
            <div class="row card-transfer-ditails">
              <div class="col-xs-12 col-sm-12 col-md-4 text-right"><strong>To:</strong></div>
              <div class="col-xs-12 col-sm-12 col-md-8">Amanda Dou</div>
            </div>
            <div class="row card-transfer-ditails">
              <div class="col-xs-12 col-sm-12 col-md-4 text-right"><strong>Card Number:</strong></div>
              <div class="col-xs-12 col-sm-12 col-md-8">
                <asp:Label runat="server" ID="Recepient" />
              </div>
            </div>
            <div class="row card-transfer-ditails">
              <div class="col-xs-12 col-sm-12 col-md-4 text-right"><strong>Amount:</strong></div>
              <div class="col-xs-12 col-sm-12 col-md-8">
                    <asp:Label runat="server" ID="Amount1" />
              </div>
            </div>
          </div>
        ...
        <div class="form-group text-center">
          ...
          <%--<a href="03a_Card2Card__card_3.aspx" type="submit" class="btn btn-success">Resume</a>--%>
        </div>
        </form>
    </div>
